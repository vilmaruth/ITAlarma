...
if(_5b[_5c]){
if(typeof (_5b[_5c].value)=="undefined"){
...
if(!dojo.hostenv.findModule("xg.profiles.embed.ShortenUrlPopup",false)){
dojo.provide("xg.profiles.embed.ShortenUrlPopup");
xg.profiles.embed.ShortenUrlPopup=function(){
var _1={};
var _={};
_.enabled=true;
_.shortenUrlLinkEnabled=true;
_.textareaChangedTimer=xg.shared.util.createQuiescenceTimer(500,function(){
_.textareaChanged();
});
_.div=null;
_.textarea=null;
...
_.key=_3.key;
_.textarea=_3.textarea;
_.addTextareaListeners();
_.div=_.createDiv();
_3.submitButton.click(function(){
if(_.textarea.val().length>_3.maxStatusLength&&_.findFirstLongUrl(_.textarea.val())){
_1.enable();
_.show();
}
});
...
_.addTextareaListeners=function(){
_.textarea.bind("keyup keypress blur cut paste change",function(_4){
_.textareaChangedTimer.trigger();
});
};
_.textareaChanged=function(){
if(_.findFirstLongUrl(_.textarea.val())){
_.show();
}else{
_.hide();
}
...
_.createDiv=function(){
var _5=x$("<div class=\"xg_floating_container xg_module xg_lightborder\">             <div class=\"xg_module_body\">                 <p>                     <a href=\"#\">"+xg.profiles.nls.html("shortenUrl")+"</a>                     <a href=\"#\" class=\"xg_icon xg_icon-close\">"+xg.profiles.nls.html("close")+"</a>                 </p>             </div>         </div>");
_.textarea.after(_5);
_5.hide();
_5.find("a:nth-child(1)").click(function(_6){
_6.preventDefault();
if(!_.shortenUrlLinkEnabled){
return;
}
_.shortenUrlLinkEnabled=false;
_.shortenUrl();
});
_5.find("a:nth-child(2)").click(function(_7){
_7.preventDefault();
_.hide();
_.enabled=false;
});
...
_.shortenUrl=function(){
var _8=_.findFirstLongUrl(_.textarea.val());
var _9=_8;
if(_9.substring(0,4).toLowerCase()==="www."){
_9="http://"+_9;
}
xg.post("/profiles/shorturl/create",{url:_9,key:_.key,source:"status"},function(_a,_b){
if(_b.url){
_.textarea.val(_.textarea.val().replace(_8,_b.url));
_.textarea.trigger("change");
}
_.hide();
_.textarea.focus();
});
};
_.findFirstLongUrl=function(_c){
var _d=_c.match(/\(*(?:\bhttps?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]|\bwww\.[A-Za-z0-9\-\.\:]+(?:[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|])?)/gi);
if(_d===null){
return null;
}
for(var i=0;i<_d.length;i++){
var _f=_d[i];
while(_f.substring(0,1)==="("&&_f.substring(_f.length-1,_f.length)===")"){
_f=_f.substring(1,_f.length-1);
}
_f=_f.replace(/^\(*/,"");
if(_f.indexOf("http://ning.it/")===0){
continue;
}
if(_f.length<="http://ning.it/XXXXXX".length){
continue;
}
return _f;
}
...
_1.getPrivateMembersForTesting=function(){
return _;
};
return _1;
};
...
this.shortenUrlPopup=xg.profiles.embed.ShortenUrlPopup();
this.shortenUrlPopup.initialize({key:this.form.attr("_urlShortenerKey"),textarea:this.statusInput,submitButton:this.submitButton,maxStatusLength:parseInt(_3.attr("_maxLength"))});
